  ...
  return (
    <div>
      ...
      <div id='ppBody'>
        ...
        <div className='innerText'>When registering on our site or app, as appropriate, you may be asked to enter your email address or other details to help you with your experience.</div><br/>
        <div className='grayText'><strong>When do we collect information?</strong></div>
        <div className='innerText'>We collect information from you when you register on our site or app, fill out a form or enter information on our site or app.</div>
        <span id='infoUs'></span><br/>
        <div className='grayText'><strong>How do we use your information? </strong></div>
        <div className='innerText'> We may use the information we collect from you when you register, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways:<br/><br/></div>
        ...
        <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To quickly process your transactions.</div>
        ...
        <div className='innerText'>We do not use Malware Scanning.<br/></div>
        ...
        <div className='innerText'>Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide a positive experience for users. https://support.google.com/adwordspolicy/answer/1316548?hl=en <br/></div>
        ...
        <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Follow the instructions at the bottom of each email and we will promptly remove you from <strong>ALL</strong> correspondence.</div>
        ...
        <div className='innerText'><br/>Last Edited on 2017-8-21</div>
      </div>
    </div>
  );
}
