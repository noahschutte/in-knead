      ...
      <div className='platform'>
        ...
        <div className='food-icon-container'>
        	<div className='food-descrip-container'>
	      		<img alt="" src={process.env.PUBLIC_URL + '/images/icon_1@2x.png'} className='food-icon'/><br/>
	      		<b><p>Who uses it?</p></b>
	      		<p>
      		...
      		<div className='food-descrip-container'>
	      		<img alt="" src={process.env.PUBLIC_URL + '/images/icon_2@2x.png'} className='food-icon'/><br/>
      		...
      		<div className='food-descrip-container'>
	      		<img alt="" src={process.env.PUBLIC_URL + '/images/icon_3@2x.png'} className='food-icon'/><br/>
	      		<b><p>Why donate?</p></b>
	      		<p>
